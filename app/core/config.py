...
class Settings:
    ...
    CORS_ORIGINS: list[str] = [o.strip() for o in os.getenv(
        "CORS_ORIGINS",
        "http://127.0.0.1:5173,http://localhost:5173,http://127.0.0.1:8080,http://localhost:8080,https://nen1090-marketing.pages.dev,https://nen-1090-app.pages.dev,https://nen1090.nl,https://www.nen1090.nl,https://app.nen1090.nl"
    ).split(",") if o.strip()]
    ...
    MARKETING_URL: str = os.getenv("MARKETING_URL", "https://nen1090-marketing.pages.dev")
