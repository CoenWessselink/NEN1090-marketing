(function () {
  const APP_ORIGIN = "https://nen-1090-app.pages.dev";
  const APP_LOGIN = `${APP_ORIGIN}/login`;
  const APP_ACTIVATE = `${APP_ORIGIN}/activate-account`;
  const APP_FORGOT_PASSWORD = `${APP_ORIGIN}/forgot-password`;
  ...
  function footerHtml() {
    return `<footer class="footer"><div class="container footer-grid"><div><div class="brand"><span class="brand-mark"></span><span>WeldInspect</span></div><p>The easiest way to manage weld inspections and compliance. Built for QA/QC managers, inspectors and project teams that need one workflow from weld to report.</p></div><div><strong>Product</strong><a href="/software.html">Features</a><a href="/pricing.html">Pricing</a><a href="/onboarding.html">Start trial</a><a href="/contact.html">Book demo</a></div><div><strong>Workflows</strong><a href="/weld-inspection-software.html">Weld inspection software</a><a href="/welding-compliance.html">Welding compliance</a><a href="/inspection-reporting.html">Inspection reporting</a><a href="${APP_FORGOT_PASSWORD}">Forgot password</a><a href="${APP_ACTIVATE}">Activate account</a></div><div><strong>Company</strong><a href="/contact.html">Contact</a><a href="/legal/privacy.html">Privacy</a><a href="/legal/terms.html">Terms</a><a href="/legal/security.html">Security</a></div></div><div class="container footer-bottom"><span>© 2026 WeldInspect</span><span>Inspectie-first · Compliance reports · Multi-tenant SaaS</span></div></footer>`;
  }
