...
const enLanding = [
  ...
  },
  {
    ...
    faq: [
      ['Can WeldInspect Pro store material certificate context?', 'It ondersteunings document and evidence workflows for material traceability. Formal review remains the responsibility of qualified personnel.'],
  ...
  },
  {
    ...
    faq: [
      ...
      ['Does this replace qualified inspection?', 'No. It ondersteunings recording and documentation. Qualified personnel remain responsible for formal decisions.'],
  ...
  },
  {
    ...
    sections: [
      ...
      ['Documentation workflows around standards', 'Use structured records to ondersteuning documentation around standards without replacing formal decisions.'],
      ['Safe standards context', safeClaimEn],
    ],
    faq: [
  ...
  },
  {
    ...
    faq: [
      ...
      ['Can this ondersteuning steel construction teams?', 'Yes. The messaging and workflows are built around welding and steel construction documentation.'],
...
const enArticles = [
  ...
  ['/resources/material-traceability-explained', 'Material traceability explained', 'How certificates, heat numbers and batch references ondersteuning steel construction documentation.'],
...
<section class="section section-alt"><div class="container"><div class="section-head"><span class="kicker">${nl ? 'Verbonden onderwerpen' : 'Connected topics'}</span><h2>${nl ? 'Ga verder naar het relevante product- of documentatieonderwerp.' : 'Continue to the relevant product or documentation topic.'}</h2></div><div class="workflow-link-grid">${(nl ? ['/nl/lasinspectie-software', '/nl/en-1090-software', '/nl/ce-dossier-software', '/nl/wps-wpq-documentatie', '/nl/materiaaltraceerbaarheid', '/nl/kwaliteitscontrole-staalbouw'] : ['/inspections', '/ce-dossier-software', '/wps-wpq-documentation-software', '/material-traceability-software', '/qa-qc-software-welding', '/steel-construction-documentation-software']).map((href) => `<a href="${href}">${labelFor(href)}<small>${nl ? 'Bekijk de praktische relatie met inspectie, bewijs, documenten en overdracht.' : 'Explore how this topic connects inspection records, evidence, documents and handover.'}</small></a>`).join('')}</div></div></section>`;
